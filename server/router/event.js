...
const {fetch_users,  get_registered_old,create ,get_new,get_old,delete_event,register_event ,get_registered , get_accepted , accept_registered} = require('../controller/event');
